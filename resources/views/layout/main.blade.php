        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse " id="navbarNavAltMarkup">
                <div class="navbar-nav ml-auto">
                    ...
                    <a class="nav-item nav-link d-inline-block mx-2 hotels" href="{{url('/kuliner')}}">kuliner</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5 mb-4">
                    ...
                    <h5 class="poppins font-weight-bold t-20px text-light">Wisata Bahari Lamongan</h5>
                    <div class="col-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-6">
                            ...
                            <ul class="p-0 mt-4" style="list-style: none;">
                                <li class="montserrats t-16px text-light">Rumah Bajak Laut</li>
                                <li class="montserrats t-16px text-light">BAnana Boat</li>
                                <li class="montserrats t-16px text-light">Jet Coaster</li>
                            </ul>
                        </div>
                        <div class="col-md-6 col-6">
                            <h5 class="poppins text-light">
                            ...
                            <ul class="p-0 mt-4" style="list-style: none;">
                                <li class="montserrats t-16px text-light">Tahu Campur</li>
                                <li class="montserrats t-16px text-light">Wingko babat</li>
                                <li class="montserrats t-16px text-light">Soto Lamongan</li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-12 text-center">
                            <img src="{{ url('img/balok-apung.png') }}" class="img-footer-instagram">
                            <img src="{{ url('img/banana-boat.jpg') }}" class="img-footer-instagram">
                            <img src="{{ url('img/bajak-laut.jpg') }}" class="img-footer-instagram">
                            <img src="{{ url('img/naik-onta.jpg') }}" class="img-footer-instagram">
                            <img src="{{ url('img/rumah-sakit-hantu.jpg') }}" class="img-footer-instagram">
                            <img src="{{ url('img/crazy-wheel.png') }}" class="img-footer-instagram">
                        </div>
                    </div>
                </div>
            </div>
